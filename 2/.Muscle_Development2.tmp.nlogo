...
to lift-weights
  ...
  ask muscle-fibers [
    if( random-float 1.0 < intensity / 100 * intensity / 100 ) [
      ...
      set catabolic-hormone catabolic-hormone + (log fiber-size 10) * (50  - food-quality / 15)
    ]
  ]
end
...
192
anabolic
mean [anabolic-hormone] of patches
2
1
11
...
192
catabolic
mean [catabolic-hormone] of patches
2
1
11
